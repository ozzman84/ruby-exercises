RSpec.describe 'reduce' do
  ...
  it 'capitalize key words in phrase' do
    ...
    result = keywords.reduce('one fish two fish red fish blue fish') do |sentence, keyword|
    # Your code goes here
      sentence.gsub(keyword, keyword.upcase)
    end
  ...
  it 'divides 560 by a bunch of numbers' do
    ...
    result = numbers.reduce(560) do |amount, number|
    # Your code goes here
    amount / number
  end
  ...
  it 'subtract smallest values from 100' do
    ...
    result = elements.reduce(100) do |value, number|
    # Your code goes here
      value - number.min
    end
